...
public class MessageModule {
                    ...
                    try {
                        ...
                        if (checkMessage(message)) {
                            ...
                            if (sender.equals(chatWindow.getCurrentClient().getName())) {
                                 ...
                                 * chatWindow.getCurrentClient().setHistory(message);
                                 */
                                MessageHistoryHandler.writeHistory(chatWindow.getCurrentClient(),message);
    ...
    protected void sendMessage() {
        try {
            ...
            /*
             * Данная строка заменена следующей за комментом:
             * chatWindow.getCurrentClient().setHistory(String.format("[%s]: %s", chatWindow.getName(), chatWindow.getMessage()));
             */
            MessageHistoryHandler.writeHistory(chatWindow.getCurrentClient(),String.format("[%s]: %s", chatWindow.getName(), chatWindow.getMessage()));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
