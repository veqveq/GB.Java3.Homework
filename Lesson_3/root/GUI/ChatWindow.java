...
public class ChatWindow extends JFrame {
    ...
    protected void setChatTitle(String title) {
         ...
         * chatHistory.setText(currentClient.getHistory());
         */
        chatHistory.setText(MessageHistoryHandler.readMessage(currentClient));
    ...
    /*
     * Класс Client лишил поля history и его обработчиков за ненадобностью
     */
...
//            if (!this.history.toString().isBlank()) this.history.append("\n");
